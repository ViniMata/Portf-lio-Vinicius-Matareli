...
export default function HomePage(){
    return (
        ...
        <div className='h-96 flex flex-col'>
            ...
            <p>Me interessei pela programação no ultimo ano e aprendi algumas coisas.</p>
            <p className='mt-10 justify-center'>Tenho experiencia em Python e React (Html, Css e JS) </p>
            </div>
        </div>
        </>
    )
